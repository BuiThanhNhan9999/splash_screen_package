  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: Stack(
          children: [
            Image.asset(
              'packages/splash_screen_package/assets/images/app_dang.png',
              fit: BoxFit.cover,
                    ...
                    child: Container(
                      ...
                      decoration: const BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: AssetImage('packages/splash_screen_package/assets/images/logoag.png')),
                      ),
                    )
                ),
                const SizedBox(height: 10),
                Text(
                  //'HỆ THỐNG THÔNG TIN QUẢN LÝ SINH HOẠT CHI BỘ',
                  widget.title?? '',
